...
def feat():
	...
	feat[1].append(	'electronic machine')
	feat[1].append(	'different problems' )
	feat[1].append(	'process data' )
	feat[1].append(	'store')
	feat[1].append(	'retrieve data' )
	feat[1].append(	'perform' )
	feat[1].append(	'calculations')
	feat[1].append(	'faster' )
	feat[1].append(	'efficiently' )
	feat[1].append(	'humans')
	feat[1].append(	'programmed' )
	feat[1].append(	'manipulates' )
	feat[1].append(	'information' )
	feat[1].append(	'automatic' )
